...
32-х битный процессор работает с оперативной памятью, размером до 4 Гб, адреса байтов изменяются от $00000000_16$ до $F F F F F F F F_16$. Процессор может работать с памятью по-разному: с моделью *flat* или с использованием *сегментов*.
