...
В реальном режиме размер сегмента фиксирован и равен 64 Кбайтам. Адрес сегмента кратен 16 и в 16-ричной с.с. может быть записан в виде $X X X X 0_16$. Старшие 4 цифры могут быть записаны в один из *сегментных регистров (селекторов)*:
