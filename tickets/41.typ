...
=== Windows
В Kernel32.dll реализованы методы WINAPI для взаимодействия с консолью, среди которых WriteConsoleA, WriteConsoleW, ReadConsoleA, ReadConsoleW и ряд других. На уровне ассемблера их можно вызвать, предварительно импортировав, с соблюдением соглашения о вызовах (fastacall в x64 и stdcall для x86).
=== Linux
