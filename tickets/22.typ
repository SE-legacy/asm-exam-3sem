...
`mask`, в зависимости от размера записи, возвращает байт или слово, соответствующее маске, которая содержит 1 в тех разрядах, которые принадлежат полю или записи.
