= Организация работы со строками переменной длины в Ассемблере
...
- Как в Pascal, задать максимально возможный размер строки (например, 255 байт), и первый байт всех строк использовать для хранения ее текущей длины. Тогда поиск конца строк будет происходить за константное время.

Пример работы со строками в Pascal-стиле. Нужно найти в строке S символ "$convolve$" и удалить его из строки:
