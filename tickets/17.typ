...
- `rcl`, `rcr` --- выполняют циклические сдвиги, причем исходное значение флага CF попадает в младший разряд, а вышедший за разрядную сетку старший разряд после этого попадает в CF.
