...
К командам побитовой обработки данных относятся логические команды, команды
сдвига, установки, сброса и инверсии битов.
...
#align(center)[$s X Y <о п . 1>, <о п. 2> [; к о м м е н т а р и й]$]
где
- X — h (логический), a (арифметический),
- Y — l (влево), r (вправо),
- $<о п . 1>$ — регистр или память,
- $<о п. 2> $— константа или младшие 5 бит регистра CL.

#align(center)[
  #image("../images/img18_1.png", width: 70%)
]

Логический сдвиг можно также считать _беззнаковым сдвигом_. То есть при сдвиге
вправо образовавшиеся пустые места заполняются 0. При арифметическом сдвиге
вправо, пустые места заполняются копиями старшего (знакового) бита. Поэтому его
называют _знаковым сдвигом_.
...
#align(center)[$s h r d space R\/M,space R,space I 8\/C L\
