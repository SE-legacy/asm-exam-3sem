...
*Макросы* похожи на подпрограммы. Описание макроса называется _макроопределением_, обращение --- _макрокомандой_. Сам процесс обращения называется _макроподстановкой_, а ее результат --- _макрорасширением_. Макросы лучше использовать для маленьких подпрограмм, а процедуры для объемных.
