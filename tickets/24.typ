...
При передаче параметров по значению, данные перед вызовом процедуры пересылаются в заранее определенное место, например, в соответствующие регистры. Т.е. процедура работает с копией данных, и входные параметры, хранящиеся в памяти, не изменяются.
