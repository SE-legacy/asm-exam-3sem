...
- `stX` (_SeT X_) --- установить флаг `X`. `X` --- это первая буква какого-нибудь флага, например `stc` установит флаг $"CF" = 1$.
- `clX` (_CLear X_) --- сбросить флаг `X`.
- `cmc` (_CoMplement Carry_) --- инвертирует флаг CF, существует только для CF.
