...
Это отражается на процессе написания DOS программ: в начале каждого COM-файла должна быть использована директива `org 100h`, которая «перепрыгнет» 256-байтовый блок префикса программного сегмента PSP, создающуюся в памяти при запуске любой программы DOS.
