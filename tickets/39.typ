...
*Замечание*: область памяти ДТА -- это 128-байтный буфер, который находится в PSP со смещением от начала этого блока по умолчанию равным 0080h, но его можно и переопределить с помощью функции 1Ah.
