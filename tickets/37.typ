...
+ Использовав файловую функцию 40h прерывания `int 21h`.
+ Использовав функции 09h, 02h ввода/вывода прерывания `int 21h`.
...
+ #int_XXh(
    ...
    В остальном действие функции аналогично действию функции 02h.
  ]
