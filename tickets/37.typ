...
+ Используя файловую функцию 40h прерывания ```asm int 21h```.
+ Используя функции 09h, 02h ввода/вывода прерывания ```asm int 21h```.
+ Обращаясь к драйверу экрана (```asm int 10h```).
